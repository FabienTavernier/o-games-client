...
While `layout/` is macro (defining the global wireframe),
...
application should be mostly composed of tiny modules.

[Sources](https://sass-guidelin.es/#components-folder)
